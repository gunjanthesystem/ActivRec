...
public class SimpleEMOriginalGunjan
{
	public SimpleEMOriginalGunjan(String inputFileName, String outputPath)
	{
		...
		try
		{
			...
			//
			// // options[2] = "-g"; // graph representation of the clusterer (Only for clusterer that implemented the
			...
			// System.out.println("\n--> Cross-validation");
			// densityBasedClusterer = new EM();
			// logLikelyhood = ClusterEvaluation.crossValidateModel(densityBasedClusterer, dataInstances, 10,
			// dataInstances.getRandomNumberGenerator(1));
