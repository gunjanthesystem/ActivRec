...
public class LastFMTools
{
	public static void main(String arg[])
	{
		...
		// dataset/lastfm-dataset/lastfm-dataset-1K/userid-timestamp-artid-artname-traid-traname.tsv";
		// // "/run/media/gunjan/OS/Users/gunjan/Documents/UCD/Research/datasets/last.fm
		// dataset/lastfm-dataset/lastfm-dataset-1K/dmicro.tsv";
		//
		// String pathToWrite =
		// "/run/media/gunjan/OS/Users/gunjan/Documents/UCD/Research/datasets/last.fm
		// dataset/lastfm-dataset/Lastfm-dataset-1K-splitted/";

		// ReadingFromFile.splitCSVFilesByColumnValueNoHeader(pathToRead, '\t', 0, pathToWrite);
		// $$ReadingFromFile.splitCSVFilesByColumnValueNoHeaderNoApache(pathToRead, "\t", 0, pathToWrite, 19150868);//
		// 160);// 19150868
