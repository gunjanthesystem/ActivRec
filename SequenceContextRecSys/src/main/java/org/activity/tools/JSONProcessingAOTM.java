...
public class JSONProcessingAOTM
{
	...
	public static Triple getAOTMFromJSON()
	{
		...
		try
		{
			...
			{
				countOfLines += 1;
				// WritingToFile.appendLineToFileAbsolute(lineRead,
				// "/run/media/gunjan/BoX1/LastFMSpaceSpace/AOTMSpace/Jul1/Log.txt");// ("line read = " + lineRead);
			...
			toWriteMsg
					.append("mixid,username,numOfSongs,sizeOfFilteredList,tsOfCreation,category, numOfSongWithMSDID\n");// ,MSDIDSeqString,artistSongSeqString\n");
			for (int i = 0; i < jsonArr.length(); i++)/// *jsonArr.length(*/
			{
				...
				// {
				// System.out.println(mixid + "," + numOfSongs + "," + sizeOfFilteredList + "," + tsOfCreation + "," +
				// category + "\n");
				// }
				...
				toWriteMsg.append(mixid + "," + userName + "," + numOfSongs + "," + sizeOfFilteredList + ","
						+ tsOfCreation + "," + category + "," + numOfSongWithMSDID + "\n");// + "," + MSDIDSeqString +
																							// "," + artistSongSeqString
																							// + "\n");
	...
	public static void main2()// String args[])
	{
		...
		String fileNameToRead = "/run/media/gunjan/BoX2/GowallaSpaceSpace/June30/gw2CheckinsSpots1Slim1TargetUsersDatesOnlyPerUserDateDWithLevels.csv";
	...
	public static void writeCatLevelInfo()
	{
		...
		String fileNameToWrite = "/run/media/gunjan/BoX2/GowallaSpaceSpace/June30/gw2CheckinsSpots1Slim1TargetUsersDatesOnlyWithLevelsV2.csv";
		int countOfLines = 0;
		StringBuffer sbuf = new StringBuffer();
		String lineRead;
