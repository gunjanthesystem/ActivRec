...
public class EntropyUtilityBelt
{
	 ...
	 * 
	 * Sample Entropy is a useful tool for investigating the dynamics of heart rate and other time series. Sample Entropy is the negative natural logarithm of an estimate of the conditional
	 * probability that subseries (epochs) of length m that match pointwise within a tolerance r also match at the next point.
	 * 
	 * @param arr
	 *            time series in (coarse-grained or otherwise)
	 * @param r
	 *            tolerance (maximum distance) (suggested value based on heart-rate series = 0.2, suggested as default value or 0.15)
	 * @param sd
	 ...
	 * 
	 * @see Based on: https://github.com/tjrantal/javaMSE/blob/master/src/edu/deakin/timo/MultiscaleEntropy.java based on http://www.physionet.org/physiotools/mse/mse.c
