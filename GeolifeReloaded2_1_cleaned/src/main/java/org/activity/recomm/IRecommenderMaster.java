...
//
// /**
// * Return the Activity Names of the Activity Objects in the current timeline, i,e, the names from 'Activity Objects
...
//
// /**
// * Generates a ranked list of recommended Activity Events according to CaseBasedV1_2 scheme: rankScore=
// * (1d-(editDistanceValExceptEnd/maxEditDistanceValExceptEnd))* simEndPointActivityObject and sets
...
// ArrayList<Triple<ActivityObject, Double, Integer>> topNextActivityEventsWithDistance,
// LinkedHashMap<Integer, Double> similarityOfEndPointActivityEventCand); // we might remove these arguments as
// // these are already member
// // variables of this class
//
// /**
// * Generates a ranked list of recommended Activity Events according to CaseBasedV1 scheme: rankScore=
// * (1d-(editDistanceValExceptEnd/maxEditDistanceValExceptEnd))* (1d-
...
// * @param similarityOfEndPointActivityEventCand
// */
// public void createRankedTopRecommendedActivityNamesCaseBasedV1(
// ArrayList<Triple<ActivityObject, Double, Integer>> topNextActivityEventsWithDistance,
// LinkedHashMap<Integer, Double> editDistanceOfEndPointActivityEventCand); // we might remove these arguments
// // as these are already member
// // variables of this class
//
// /**
// * Generates a ranked list of recommended Activity Events according to SimpleV3 scheme: rankScore= 1d -
// * (editDistanceVal/maxEditDistanceVal);
// *
// * and sets recommendedActivityNamesRankscorePairs
// *
// * and calls the following setter methods setRecommendedActivityNamesWithRankscores
...
//
// /**
// * Sets the string rankedRecommendedActivityNameWithRankScores as
// * '__recommendedActivityName1:rankScore1__recommendedActivityName2:rankScore2'
// *
...
//
// /**
// * Sets the string rankedRecommendedActivityNameWithoutRankScores as
// * '__recommendedActivityName1__recommendedActivityName2'
// *
// * @param recommendedActivityNameRankscorePairs
// * @return
// */
...
//
// /**
// * Removes the recommendation instant Activity name, i.e., the Current Activity Name from the
