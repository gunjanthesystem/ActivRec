...
//
/// **
// * An abstract class for Recommendation Masters
// *
// * @since 8 Mar 2017
// * @author gunjan
// *
// */
// abstract class RecommendationMasterAbstract
// {
...
// // here key is the TimelineID, which is already a class variable of Value, So we could have used ArrayList but we
// // used LinkedHashMap purely for search performance reasons
// private LinkedHashMap<Integer, TimelineWithNext> candidateTimelines;
//
// private TimelineWithNext currentTimeline;
//
...
// */
// private ArrayList<ActivityObject> activitiesGuidingRecomm;
//
// /**
...
//
// private String activityNameAtRecommPoint;
//
// // /**
// // * current Activity Name
// // */
// // private String activityNameAtRecommPoint; //TODO: remove this from child classes as well
//
// /**
...
// * <p>
// * <font color=orange> its a similarity and not edit distance</font>
// */
// private LinkedHashMap<Integer, Double> similarityOfEndPointActivityObjectCand;
//
// /**
...
//
// // public final String lookPastType; //TODO include this in MU recommender
//
// public final String recommenderType; // MU,DayWise, DayWiseST
//
...
// AlignmentBasedDistance alignmentBasedDistance; // TODO: CHECK if this this is needed
...
// * @return
// */
// public int initialiseDistancesUsed(String distanceName)
// {
// alignmentBasedDistance = new AlignmentBasedDistance(); // used for case based similarity
// // String dname = Constant.getDistanceUsed(); // used for distance of candidate timelines from the current
// // timeline
//
// switch (distanceName)
// {
...
//
// default:
// String errorMsg = "Error in org.activity.recomm.RecommendationMasterMU.initialiseDistanceUsed(): Unknown distance
// specified:"
// + distanceName;
// PopUps.showError(errorMsg);
// System.err.println(PopUps.getCurrentStackTracedErrorMsg(errorMsg));
// System.exit(-1);
// }
// return 0;
// }
...
// * @param lookPastType
// */
// public RecommendationMasterAbstract(LinkedHashMap<Date, UserDayTimeline> trainingTimelines,
// LinkedHashMap<Date, UserDayTimeline> testTimelines, String dateAtRecomm, String timeAtRecomm,
// int userAtRecomm, double thresholdVal, String typeOfThreshold, String recommenderType)
// // double matchingUnitInCountsOrHours, String caseType, String lookPastType, boolean dummy // counts or hours
// {
// System.out.println("\n----------------Starting RecommendationMasterAbstract " + "---------------------");
//
...
// if (Constant.verbose)
// {
// System.out.println(" User at Recomm = " + this.userAtRecomm); //// LOGGING
...
// // this.candidateTimelines = getCandidateTimelinesMU(trainingTimeline, matchingUnitInCountsOrHours,
...
// editDistancesSortedMapFullCand.size() && editDistancesSortedMapFullCand.size()== this.candidateTimelines.size() not
// satisfied");
// errorExists = true;
// }
//
...
// {
// ArrayList<Triple<ActivityObject, Double, Integer>> topActivityObjects = new ArrayList<Triple<ActivityObject, Double,
// Integer>>(); // Pair
// // <Next
// // Activity
// // Object,edit
...
// getFeatureWiseEditDistancesForCandidateTimelinesFullCand(
// LinkedHashMap<Integer, TimelineWithNext> candidateTimelines,
// ArrayList<ActivityObject> activitiesGuidingRecomm, String caseType, String userAtRecomm,
// String dateAtRecomm, String timeAtRecomm)
// {
// // <CandidateTimeline ID, Edit distance>
// LinkedHashMap<Integer, LinkedHashMap<String, Pair<String, Double>>> candEditDistancesFeatureWise = new
// LinkedHashMap<Integer, LinkedHashMap<String, Pair<String, Double>>>();
//
// for (Map.Entry<Integer, TimelineWithNext> entry : candidateTimelines.entrySet())
// {
...
// default:
// PopUps.showError(
// "Error in org.activity.recomm.RecommendationMasterMU.getNormalisedDistancesForCandidateTimelinesFullCand(): Unknown
// distance specified:"
// + distanceUsed);
// System.err.println(
// "Error in org.activity.recomm.RecommendationMasterMU.getNormalisedDistancesForCandidateTimelinesFullCand(): Unknown
...
// * @return
// */
// public LinkedHashMap<Integer, Pair<String, Double>>
...
// String dateAtRecomm, String timeAtRecomm)
// {
// LinkedHashMap<Integer, Pair<String, Double>> candEditDistances =
// getOTMDSAMEditDistancesForCandidateTimelinesFullCand(
// candidateTimelines, activitiesGuidingRecomm, caseType, userAtRecomm, dateAtRecomm, timeAtRecomm);
//
// LinkedHashMap<Integer, Pair<String, Double>> normalisedCandEditDistances = normalisedDistancesOverTheSet(
// candEditDistances, userAtRecomm, dateAtRecomm, timeAtRecomm);
...
// {
//
// LinkedHashMap<Integer, LinkedHashMap<String, Pair<String, Double>>> normalisedDistancesPerCand = new
// LinkedHashMap<Integer, LinkedHashMap<String, Pair<String, Double>>>();
//
...
// Integer candID = entry.getKey();
// LinkedHashMap<String, Pair<String, Double>> featureWiseDistances = entry.getValue();
// LinkedHashMap<String, Pair<String, Double>> normalisedFeatureWiseDistances = new LinkedHashMap<String, Pair<String,
// Double>>();
//
// int featureIndex = 0;
// for (Map.Entry<String, Pair<String, Double>> distEntry : featureWiseDistances.entrySet()) // iterating over
...
// LinkedHashMap<Integer, LinkedHashMap<String, Pair<String, Double>>> normalisedCandEditDistances)
// {
// LinkedHashMap<Integer, Pair<String, Double>> aggregatedFeatureWiseDistances = new LinkedHashMap<Integer, Pair<String,
// Double>>();
//
...
// String timeAtRecomm)
// {
// LinkedHashMap<Integer, Pair<String, Double>> normalisedDistances = new LinkedHashMap<Integer, Pair<String,
// Double>>();
//
...
//// LinkedHashMap<Integer, Double> editDistanceOfEndPointActivityObjectCand) // we might remove these arguments as
// these
...
//// (endPointActivityEditDistanceVal / maxEditDistanceValOfEnd));
////
//// System.out.println("RANK SCORE CALCULATION=" + "(1d-(" + editDistanceValExceptEnd + "/" +
// maxEditDistanceValExceptEnd
//// + "))* (1d- (" +
