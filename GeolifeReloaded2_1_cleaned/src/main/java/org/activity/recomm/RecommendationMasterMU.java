// Was correct, but commented out on March 13 2017 and replaced by the fork
// org.activity.recomm.RecommendationMasterMUMar2017 which is a cleaner,
// improved version
...
// * generates recommendations using the matching-unit (MU) approach. Timelines are not viewed as Day Timeline but
// rather
// * as continuous timelines. The matching-unit can be specified as 'hours' or 'counts'.
// *
// * Timelines are sets of Activity Objects, (and they do not necessarily belong to one day.) (the matching unit used
// here
...
// // here key is the TimelineID, which is already a class variable of Value, So we could
// // have used ArrayList but we used LinkedHashMap purely for search performance reasons
//
