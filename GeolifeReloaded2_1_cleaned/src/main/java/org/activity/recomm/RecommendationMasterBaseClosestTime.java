...
// * The primary purpose of this class is to provide a simple recommender which will be used as a baseline to compare
// our
// * proposed two-level recommender </br>
// * Algorithm in words:
// * <ol>
// * <li>For each RT, the candidate timelines are all timelines in the training.</li>
// * <li>To get the top recommended activity: from each candidate timeline, select candidate Activity Objects which is
// the
...
// LinkedHashMap<Date, Triple<Integer, ActivityObject, Double>> startTimeDistanceUnsortedMap = new LinkedHashMap<Date,
// Triple<Integer, ActivityObject, Double>>(); //
//
...
// {
// System.out.println(
// ">>>>>>>>>>>>>>startTimeDistanceSortedMap is:>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n Date, Index of nearest, name of
// nearest, dist of nearest");
...
// LinkedHashMap<Date, Triple<Integer, ActivityObject, Double>> distances = new LinkedHashMap<Date, Triple<Integer,
// ActivityObject, Double>>();
//
...
//
// result.append("__" + tripleAO.getSecond().getActivityName());//
...
// Triple<Integer, ActivityObject, Double> tripleAO = entry.getValue();
//
// result.append("__" + tripleAO.getSecond().getActivityName() + ":" + tripleAO.getThird().toString());//
// result=result+"__"+pairAE.getFirst().getActivityName();
// }
// return result.toString();
// }
