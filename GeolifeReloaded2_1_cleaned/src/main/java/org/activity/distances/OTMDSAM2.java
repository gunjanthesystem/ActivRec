...
public class OTMDSAM2 extends AlignmentBasedDistance
{
	...
	public Pair<String, Double> getOTMDSAMEditDistanceWithTrace(ArrayList<ActivityObject> activityObjects1, ArrayList<ActivityObject> activityObjects2)
	{
		LinkedHashMap<String, Pair<String, Double>> featureWiseEditDistance = new FeatureWiseEditDistance().getFeatureWiseEditDistanceWithTrace(activityObjects1, activityObjects2);
		@SuppressWarnings("rawtypes")
		ArrayList allEditOperations = getAllEditOperations(featureWiseEditDistance);
		
		if (allEditOperations.size() > 3)
		{
			System.err.println("Error in org.activity.distances.OTMDSAM.getOTMDSAMEditDistance() size of allEditOperations (>3) = " + allEditOperations.size()); // because it should be for insertions,
																																									// deletions and replacements, and
																																									// thus only three elements
		}
		return calculateOTMDSAMDistance((ArrayList<Pair<Integer, String>>) allEditOperations.get(0), (ArrayList<Pair<Integer, String>>) allEditOperations.get(1),
	 ...
	 * 
	 * @param pairs
	 * @return an ArrayList where the first element is an ArrayList of insertions, seconds element is an ArrayList of deletions and third element us an ArrayList of replacements
	 */
	@SuppressWarnings("rawtypes")
	public ArrayList getAllEditOperations(LinkedHashMap<String, Pair<String, Double>> pairs)
	{
		// Obtain the list of insertion, deletions and replacements operations for minimum edit distance for all features.
		...
		if (Constant.verboseOTMDSAM)
			System.out.println("Inside getAllEditOperations");
	 ...
	 * 
	 * @param insertions
	 *            ArrayList containing all insertions for edit distances for all features as Pair<Position of insertion from target, feature name>
	 * @param deletions
	 *            ArrayList containing all deletion for edit distances for all features as Pair<Position of deletion in source, feature name>
	 * @param replacements
	 *            ArrayList containing all replacements for edit distances for all features as Triple<Position of replacement in source,Position of replacement from target, feature name>
	 * @return
	 */
	public final Pair<String, Double> calculateOTMDSAMDistance(ArrayList<Pair<Integer, String>> insertions, ArrayList<Pair<Integer, String>> deletions,
			ArrayList<Triple<Integer, Integer, String>> replacements)
	{
	 ...
	 * @return
	 */
	public final Pair<String, Double> getOTMDSAMEditDistanceWithoutEndCurrentActivity(ArrayList<ActivityObject> activityObjects1Original,
			ArrayList<ActivityObject> activityObjects2Original)// , String userAtRecomm, String dateAtRecomm, String timeAtRecomm, Integer candidateTimelineId)
	{
		...
		Pair<String, Double> result = getOTMDSAMEditDistanceWithTrace(activityObjects1, activityObjects2);// , userAtRecomm, dateAtRecomm, timeAtRecomm,
																											// candidateTimelineId);
	 ...
	 * @return
	 */
	public final Pair<String, Double> getOTMDSAMEditDistanceInvalidsExpunged(ArrayList<ActivityObject> activityObjects1, ArrayList<ActivityObject> activityObjects2)// , String userAtRecomm,
	// String dateAtRecomm, String timeAtRecomm, Integer candidateTimelineId)
	{
		return getOTMDSAMEditDistanceWithTrace(expungeInvalids(activityObjects1), expungeInvalids(activityObjects2));// , userAtRecomm, dateAtRecomm, timeAtRecomm, candidateTimelineId);//
																														// similarity;
	}
	 ...
	 * @return
	 */
	public final Pair<String, Double> getOTMDSAMEditDistanceWithoutEndCurrentActivityInvalidsExpunged(ArrayList<ActivityObject> activityObjects1,
			ArrayList<ActivityObject> activityObjects2)
	{
		return getOTMDSAMEditDistanceWithoutEndCurrentActivity(expungeInvalids(activityObjects1), expungeInvalids(activityObjects2));
	}
	 ...
	 * @param replacements
	 */
	public void printAllEditOperations(ArrayList<Pair<Integer, String>> insertions, ArrayList<Pair<Integer, String>> deletions, ArrayList<Triple<Integer, Integer, String>> replacements)
	{
	 ...
	 * @param pairs
	 */
	public final void traverse(HashMap<String, Pair<String, Double>> pairs)// , ArrayList<ActivityObject> activityObjects1, ArrayList<ActivityObject> activityObjects2)
	...
	// * @param activityObjects1
	// * @param activityObjects2
	// * @return ArrayList of Pairs where each Pair objetc contains the levenshtein distance for that feature and the trace of operations
	// */
	// // getFeatureStringLevenshteinSAXWithTrace
	// public final LinkedHashMap<String, Pair<String, Double>> getOTMDSAMEditDistanceWithTrace(ArrayList<ActivityObject> activityObjects1, ArrayList<ActivityObject> activityObjects2)
	// {
	// /**
	...
	// Pair<String, Double> levenshteinActivityName = getMySimpleLevenshteinDistance(stringCodeForActivityNames1, stringCodeForActivityNames2, 1, 1, 2);
	...
	// // Pair<String, Double> levenshteinStartTime = getMySimpleLevenshteinDistance(stringCodeForStartTime1, stringCodeForStartTime2, 1, 1, 2);
	...
	// // String stringCodeForStartTime2 = StringCode.getStringCodeForStartTime(activityObjects2);
	// Pair<String, Double> levenshteinStartTime = getMySimpleLevenshteinDistance(stringCodeForStartTimes[0], stringCodeForStartTimes[1], 1, 1, 2);
	// mapOfDistances.put("StartTime", levenshteinStartTime);
	// }
	//
	...
	// Pair<String, Double> levenshteinDuration = getMySimpleLevenshteinDistance(stringCodeForDurations[0], stringCodeForDurations[1], 1, 1, 2);
	// mapOfDistances.put("Duration", levenshteinDuration);
	// }
	//
	// if (Constant.DATABASE_NAME.equals("geolife1"))
	// {
	// // if (Constant.considerAllFeaturesForOTMDSAMEditDistance || Constant.considerDistanceTravelledInOTMDSAMEditDistance)
	// {
	// // String stringCodeForDistanceTravelled1 = StringCode.getStringCodeForDistanceTravelled(activityObjects1);
	// String stringCodesForDistanceTravelled[] = StringCode.getStringCodesForDistanceTravelled(activityObjects1, activityObjects2);
	// Pair<String, Double> levenshteinDistanceTravelled = getMySimpleLevenshteinDistance(stringCodesForDistanceTravelled[0], stringCodesForDistanceTravelled[1], 1, 1, 2);
	...
	// // Pair<String, Double> levenshteinStartGeo = getMySimpleLevenshteinDistance(stringCodeForStartGeo1, stringCodeForStartGeo2, 1, 1, 2);
	...
	// // Pair<String, Double> levenshteinEndGeo = getMySimpleLevenshteinDistance(stringCodeForEndGeo1, stringCodeForEndGeo2, 1, 1, 2);
	//
	// // if (Constant.considerAllFeaturesForOTMDSAMEditDistance || Constant.considerStartGeoCoordinatesInOTMDSAMEditDistance)
	// {
	// String stringCodesForStartGeoCoordinates[] = StringCode.getStringCodesForStartGeoCoordinates(activityObjects1, activityObjects2);
	// Pair<String, Double> levenshteinStartGeoCordinates = getMySimpleLevenshteinDistance(stringCodesForStartGeoCoordinates[0], stringCodesForStartGeoCoordinates[1], 1, 1, 2);
	// mapOfDistances.put("StartGeoCordinates", levenshteinStartGeoCordinates);
	// }
	//
	// // if (Constant.considerAllFeaturesForOTMDSAMEditDistance || Constant.considerEndGeoCoordinatesInOTMDSAMEditDistance)
	// {
	// String stringCodesForEndGeoCoordinates[] = StringCode.getStringCodesForEndGeoCoordinates(activityObjects1, activityObjects2);
	// Pair<String, Double> levenshteinEndGeoCordinates = getMySimpleLevenshteinDistance(stringCodesForEndGeoCoordinates[0], stringCodesForEndGeoCoordinates[1], 1, 1, 2);
	...
	// String stringCodesForAvgAltitude[] = StringCode.getStringCodesForAvgAltitudes(activityObjects1, activityObjects2);
	// Pair<String, Double> levenshteinAvgAltitude = getMySimpleLevenshteinDistance(stringCodesForAvgAltitude[0], stringCodesForAvgAltitude[1], 1, 1, 2);
