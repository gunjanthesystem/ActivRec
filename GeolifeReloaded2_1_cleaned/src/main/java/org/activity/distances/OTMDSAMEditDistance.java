...
public class OTMDSAMEditDistance extends AlignmentBasedDistance
{
			...
			Integer candidateTimelineId)
	{
		...
		LinkedHashMap<String, Pair<String, Double>> featureWiseEditDistance =
				new FeatureWiseEditDistance().getFeatureWiseEditDistanceWithTrace(activityObjects1, activityObjects2);
		@SuppressWarnings("rawtypes")
		ArrayList allEditOperations = getAllEditOperations(featureWiseEditDistance);
		
		if (allEditOperations.size() > 3)
		{
			System.err.println("Error in org.activity.distances.OTMDSAM.getOTMDSAMEditDistance() size of allEditOperations (>3) = "
	...
	public ArrayList getAllEditOperations(LinkedHashMap<String, Pair<String, Double>> pairs)
	{
		...
		// <Pair<Coordinate of replacement in source,Coordinate of replacement from target>>, lists of feature names in which this replacement happens>
		LinkedHashMap<Pair<Integer, Integer>, ArrayList<String>> replacements =
				new LinkedHashMap<Pair<Integer, Integer>, ArrayList<String>>();
	 ...
	 * @param replacements
	 *            ArrayList containing all replacements for edit distances for all features as Triple<Position of replacement in source,Position of replacement from target, feature
	 *            name>
	 * @return
	 */
	public final Pair<String, Double> calculateOTMDSAMDistance(LinkedHashMap<Integer, ArrayList<String>> insertions,
			LinkedHashMap<Integer, ArrayList<String>> deletions, LinkedHashMap<Pair<Integer, Integer>, ArrayList<String>> replacements)
	{
			...
			Integer candidateTimelineId)
	{
		...
		Pair<String, Double> result = getOTMDSAMEditDistanceWithTrace(activityObjects1, activityObjects2, userAtRecomm, dateAtRecomm,
	...
	public final Pair<String, Double> getOTMDSAMEditDistanceInvalidsExpunged(ArrayList<ActivityObject> activityObjects1,
			...
			Integer candidateTimelineId)
	{
		return getOTMDSAMEditDistanceWithTrace(expungeInvalids(activityObjects1), expungeInvalids(activityObjects2), userAtRecomm,
	 ...
	 * @param replacements
	 */
	public void printAllEditOperations(ArrayList<Pair<Integer, String>> insertions, ArrayList<Pair<Integer, String>> deletions,
	...
	{
		LinkedHashMap<Integer, ArrayList<String>> insertions = (LinkedHashMap<Integer, ArrayList<String>>) allEditOperations.get(0);
		LinkedHashMap<Integer, ArrayList<String>> deletions = (LinkedHashMap<Integer, ArrayList<String>>) allEditOperations.get(1);
		LinkedHashMap<Pair<Integer, Integer>, ArrayList<String>> replacements =
				(LinkedHashMap<Pair<Integer, Integer>, ArrayList<String>>) allEditOperations.get(2);
	...
	// public final LinkedHashMap<String, Pair<String, Double>> getOTMDSAMEditDistanceWithTrace(ArrayList<ActivityObject> activityObjects1, ArrayList<ActivityObject>
	// activityObjects2)
	// {
	// /**
