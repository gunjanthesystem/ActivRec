...
public class ActivityObject implements Serializable
{
	 ...
	 */
	ActivityObject(HashMap<String, String> dimensionIDNameValues) // (User_ID, 0), (Location_ID, 10100), ...
	{
		...
		this.startTimestamp = UtilityBelt.getTimestamp(startTimeString, startDateString); // in iiWAS ver, dateString is
																							// used here instead of
																							// startDateString
		this.endTimestamp = UtilityBelt.getTimestamp(endTimeString, endDateString);// in iiWAS ver, dateString is used
	...
	ActivityObject(String name, Timestamp start, Timestamp end)
	{
		// userName=user;
		activityName = name;
