...
public final class Constant
{
	 ...
	 */
	public static final boolean EXPUNGE_INVALIDS_B4_RECOMM_PROCESS = true;// false;// true; NOT NEEDED IN CASE OF
																			// GOWALLA //TODO check the places where
																			// this is involved so that it
																			// can safely be set to false

	public static final boolean BLACKLISTING = false;// true;// true; // to have the same RTs in daywise and MU, some
	...
	public static void setActivityNames()
	{
		try
		{
			...
			case "gowalla1":
				...
				LinkedHashSet<String> res = UIUtilityBox.getNodesAtGivenDepth(gowallaWorkingCatLevel,
						rootOfCategoryTree);
