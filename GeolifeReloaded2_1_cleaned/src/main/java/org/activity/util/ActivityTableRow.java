...
public class ActivityTableRow
{
	...
	public ActivityTableRow(String user, String day, String activity, String location, String activityStartTime, String activityEndTime, String date)
	{
		this.user = user;
		this.day = day;
	...
	{
		String variableNames[] = { "user", "day", "activity", "location", "activityStartTime", "activityEndTime", "date" };
