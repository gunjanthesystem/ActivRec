...
public class MetaBase
{
	...
	public static AttributeControlObject identifyAttribute(String attributeName)
	{
		...
		{
			ArrayList<AttributeControlObject> attributeControlObjects = dimensionControlObject.getAttributeControlObjects();
			
			// System.out.println("inside identify AttributeControl: current dimension search"+dimensionControlObject.getDimensionName());
			
			for (AttributeControlObject attributeControlObject : attributeControlObjects)
			{
				// System.out.println("inside identify AttributeControl: current attribute to see"+attributeControlObject.getName());
