...
public class DateTimeUtils
{
	...
	public static String getWeekDayFromDateString(String date) // dd-mm-yyyy
	{
		...
		Date date1 = new Date(Integer.valueOf(splitted[2]) - 1900, Integer.valueOf(splitted[1]) - 1, Integer.valueOf(splitted[0]));
	...
	public static Timestamp getIncrementedTimestamp(Timestamp initialTimestamp, int incrementInSeconds)
	{
		...
		// System.out.println(" adding seconds to timestamp: "+initialTimestamp+"+"+incrementInSeconds+"seconds ="+resultTimestamp);
		return resultTimestamp;
	}
	
	public static String getTimeString(Timestamp timestamp)
	{
		// System.out.println(" Inside getTimeString: timestamp="+timestamp+" extracted time="+timestamp.getHours()+":"+timestamp.getMinutes()+":"+timestamp.getSeconds());
	...
	public static boolean isSameDate(Timestamp ts1, Timestamp ts2)
	{
		...
		if (ts1.getYear() != ts2.getYear())
			return false;
		if (ts1.getMonth() != ts2.getMonth())
			return false;
