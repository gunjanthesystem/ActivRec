...
/**
 * Splits the set of users into training and test set based on the class label (based on best matching-unit) assigned to them.
 * 
 * @author gunjan
 *
 */
public class SplitTrainingTestUsersBalanced
{
	...
	public Pair<ArrayList<String>, ArrayList<String>> splitIntoTrainingTestEquiDistribution(LinkedHashMap<String, ArrayList<String>> threeClasses, double percentageInTraining)
	{
		Pair<ArrayList<String>, ArrayList<String>> trainingTestUsers = new Pair<ArrayList<String>, ArrayList<String>>(); // first traing, second test
		//
		...
		for (Map.Entry<String, ArrayList<String>> entry : threeClasses.entrySet())
		{
			...
			{
				System.out.println("Warning: for classLabel: " + classLabel + "  num of test users was less than 1 and thus increasing to 1");
				numberOfUsersForTest = 1;
				numberOfUsersForTraining = numOfUsers - numberOfUsersForTest;
			}
			
			System.out.println("ClassLabel =" + classLabel + "  num of training usersd = " + numberOfUsersForTraining + "num of test users= " + numberOfUsersForTest);
	...
	private LinkedHashMap<String, ArrayList<String>> splitIntoClasses(LinkedHashMap<String, String> userClassMap)
	{
		...
		{
			System.out.println("Class Label: " + entry.getKey() + "  num of users: " + entry.getValue().size() + "  Users: " + entry.getValue().toString());
		}
