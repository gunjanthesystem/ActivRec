...
public class ControllerServlet extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		/*
		 * if(request.getParameter("selectStringPost")!=null && request.getParameter("aggregateBy")==null && request.getParameter("reduciblePost")!= null) { System.out.println("reducible post"); String whereQueryString = request.getParameter("whereQueryStringPost"); //%%System.out.println("where query string in controller servlet="+whereQueryString);
		 * 
		 ...
		 * 
		 * try { //System.out.println(ConnectDatabase.getInnerJoinString()); JSONArray jsonArrayForDataTable = ConnectDatabase.getJSONArrayOfDataTable(selectAttributeString,whereQueryString); //%%System.out.println(jsonArrayForDataTable.toString()); //$$request.setAttribute("jsonStringForDataTable", jsonArrayForDataTable); String jsonArrayForDataTableString=jsonArrayForDataTable.toString();
		 * 
		 * jsonArrayForDataTableString =UtilityBelt.reduceJSONString(selectAttributeString,jsonArrayForDataTableString); //jsonArrayForDataTableString = jsonArrayForDataTableString.replace('_',' ');
		 * 
		 * 
		...
		/*
		 * if(request.getParameter("attributeControlAggregationPost")!=null) { String attributeControlNamePost=""; attributeControlNamePost=request.getParameter("attributeControlAggregationPost");
		 * 
