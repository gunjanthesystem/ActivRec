...
public class ChartBoardScene
{
	 ...
	 */
	public ChartBoardScene(List<Pair<Node, String>> listOfNodesToAddToTabPaneWithTitles)
	{
		System.out.println("ChartBoardScene(listOfNodesToAddToTabPaneWithTitles) called");
	...
	// /////////////////////////////////////////////
	// tabPane = new TabPane();
	// createTabs2();// (listOfNodesToAddToTabPaneWithTitles);
	// /////////////////////////////////////////////
	// VBox.setVgrow(tabPane, Priority.ALWAYS);
	// VBox.setVgrow(vBoxSidePane, Priority.ALWAYS);
	//
	...
	{
		System.out.println("cb.getScene() called");
		return this.scene1;
	}
