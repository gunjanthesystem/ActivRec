...
public class DatabaseCreatorDCU
{
	...
	{
		String datasetAddressStefan = commonPathToRead + "Data_Set_Stefan/Data Set";
		listFilesForFolder(new File(datasetAddressStefan), datasetAddressStefan, "Stefan", commonPathToRead);

		String datasetAddressTengqi = commonPathToRead + "Data_Set_TengQi/tengqi";
		listFilesForFolder(new File(datasetAddressTengqi), datasetAddressTengqi, "Tengqi", commonPathToRead);

		String datasetAddressCathal = commonPathToRead + "Data_Set_Cathal/two weeks of data/two weeks of data";
		listFilesForFolder(new File(datasetAddressCathal), datasetAddressCathal, "Cathal", commonPathToRead);

		String datasetAddressZaher = commonPathToRead + "Data_Set_Zaher";
		listFilesForFolder(new File(datasetAddressZaher), datasetAddressZaher, "Zaher", commonPathToRead);

		String datasetAddressRami = commonPathToRead + "Data_Set_Rami";
		listFilesForFolder(new File(datasetAddressRami), datasetAddressRami, "Rami", commonPathToRead);
