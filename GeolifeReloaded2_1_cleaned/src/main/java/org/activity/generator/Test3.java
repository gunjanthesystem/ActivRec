...
public class Test3
{
	...
	public static void main1(String[] args)
	{
		...
		HashMap<Long, ArrayList<String>> subset1Map = org.activity.generator.DatabaseCreatorGowallaQuickerPreprocessor.readSpotSubset(subset1Filename);
