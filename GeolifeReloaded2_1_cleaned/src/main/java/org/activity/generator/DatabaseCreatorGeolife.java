...
public class DatabaseCreatorGeolife
{
	...
	public static String commonPath =
			"/run/media/gunjan/OS/Users/gunjan/Documents/UCD/Projects/GeoLife/link to Geolife Data Works/Mar162016AllUsersDataGeneration/";// ///"/run/media/gunjan/Space/GUNJAN/GeolifeSpaceSpace/Mar152016AllUsersDataGeneration/";//
	...
	public static final int continuityThresholdInSeconds = 5 * 60; // changed from 30 min in DCU dataset...., if two timestamps are separated by less than equal to this value and
																	// have same mode name,
	...
	public static void main(String args[])
	{
		...
		try
		{
			 ...
			 * "timestamp, endt,mode,timedifferenceWithNextInSeconds,durationInSeconds,breakOverDaysCount,trajID,,latitude,longitude,alt", true);$$
			 */
			// ImP
			...
			System.out.println("getTrajectoryEntriesWithTimeDifferenceWithNext done in " + ((ct3_1 - ct1) / 1000) + " seconds since start");
			
			mapForAllDataMergedContinuousWithDuration = mergeContinuousTrajectoriesAssignDurationWithoutBOD2TrajSensitive(mapForAllData);
			...
			// WritingToFile.writeActivityTypeWithDurationGeo(mapForAllDataMergedContinuousWithDuration, "Not Available", "MergedContinuous",
			// true);
			// WritingToFile.writeActivityTypeWithDurationGeo(mapForAllDataMergedContinuousWithDuration, "Unknown", "MergedContinuous", true);
			// ImP
			 ...
			 * 
			 * mapForAllDataMergedSandwichedWithDuration = mergeSmallSandwiched(mapForAllDataMergedContinuousWithDuration,"badImages"); mapForAllDataMergedSandwichedWithDuration =
			...
			writeDataToFile2WithHeadersWithTrajPurityCheck(
					mapForAllDataMergedContinuousWithDuration,
					"DataGenerated",
