...
public class Dimension implements Serializable
{
	...
	Dimension(String dimensionName, String dimensionPrimaryKeyValue)
	{
		...
		try
		{
			...
			// ArrayList of Attributes of this dimension. Each ArrayList element is an ArrayList of attribute's parameters. The attribute parameters are 'attribute name','datatype'
			...
			if (countCheck > 1)
			{
				System.err.println("Error in Dimension constructor: more than one rows returned from database for dimension="
