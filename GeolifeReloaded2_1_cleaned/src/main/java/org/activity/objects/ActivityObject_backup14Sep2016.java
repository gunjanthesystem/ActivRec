...
/**
 * <p>
 * Created as a backup. This is copy of the Activity Object used until 14 Sep 2016 and used in Geolife experiments.
 * </p>
 * 
 * @author gunjan
 *
 */
public class ActivityObject_backup14Sep2016 implements Serializable
{
	/**
	 * 
	 */
	...
	public double getDifferenceStartingGeoCoordinates(ActivityObject_backup14Sep2016 ao2)
	{
		return UtilityBelt.haversine(startLatitude, startLongitude, ao2.getStartLatitude(), ao2.getStartLongitude());
		
	}
	
	public double getDifferenceEndingGeoCoordinates(ActivityObject_backup14Sep2016 ao2)
	{
		return UtilityBelt.haversine(endLatitude, endLongitude, ao2.getEndLatitude(), ao2.getEndLongitude());
		
	}
	
	public double getDifferenceAltitude(ActivityObject_backup14Sep2016 ao2)
	{
		return Double.parseDouble(this.getAvgAltitude()) - Double.parseDouble(ao2.getAvgAltitude());
		
	}
	
	public static String getArrayListOfActivityObjectsAsString(ArrayList<ActivityObject_backup14Sep2016> arr)
	{
		StringBuffer str = new StringBuffer("");
		
		for (ActivityObject_backup14Sep2016 ao : arr)
		{
	 ...
	 */
	public ActivityObject_backup14Sep2016(HashMap<String, String> dimensionIDNameValues) // (User_ID, 0), (Location_ID, 10100), ...
	{
	 ...
	 */
	ActivityObject_backup14Sep2016()
	{
	 ...
	 */
	ActivityObject_backup14Sep2016(String activityName, String location, long durationInSeconds, Timestamp startTimeStamp)
	{
	...
	public boolean equals(ActivityObject_backup14Sep2016 aeToCompare)
	{
		boolean equal = true;
	 ...
	 * @return
	 */
	public static String getStringCodeForActivityObjects(ArrayList<ActivityObject_backup14Sep2016> ActivityObjects)
	{
	...
	public ActivityObject_backup14Sep2016(String name, Timestamp start, Timestamp end)
	{
		// userName=user;
		activityName = name;
