...
/**
 * 
 * This class should represent a generic data point entry from any dataset. Note: earlier i used to create custom data
 * entry classes for each data: for example, FlatActivityLogEntry for DCU dataset and TrajectoryEntry for Geolife
 * dataset.
 * 
 * @author gunjan
 * @since 28 April 2016
