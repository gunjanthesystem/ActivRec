...
public class TestExperiments
{
	...
	public static void checkPair()
	{
		...
		System.out.println("p1:" + p1.toString() + ",p2:" + p2.toString() + "  equals:" + p1.equals(p2)
				+ "  ignore order:" + p1.equalsIgnoreOrder(p2));
		System.out.println("p1:" + p1.toString() + ",p3:" + p3.toString() + "  equals:" + p1.equals(p3)
				+ "  ignore order:" + p1.equalsIgnoreOrder(p3));
		System.out.println("p3:" + p3.toString() + ",p3:" + p3.toString() + "  equals:" + p3.equals(p3)
				+ "  ignore order:" + p3.equalsIgnoreOrder(p3));
	...
	{
		String timeSeriesFile = "/run/media/gunjan/HOME/gunjan/Geolife Data Works/stats/TimeSeries2/geolife1JUL6TimeSeriesAnalysis_UsersAbove10RTs/testy5.csv";
		double r = 0.2;// 00001;
		// int mMax = 2;
		int maxScale = 2;
		int m = 2;
	...
	public static void main0(String[] args)
	{
		try
		{
			...
			try
			{
				...
				// WritingToFile.appendLineToFileAbsolute("test,test,test",
				// "/run/media/gunjan/Space/GUNJAN/GeolifeSpaceSpace/Temp/temp.csv");
				...
				sampleEntropyOnSymbolicSeqExperiment(
						"/run/media/gunjan/HOME/gunjan/Geolife Data Works/stats/wekaResults/SampEnExperiments/"
				...
				// .executeShellCommand("mseG -m 1 -M 12 -b 1 -r 0.000001 -R 0.000001 -n 1
				// </home/gunjan/cprograms/Testy1>/home/gunjan/cprograms/delete1_3.mse"));
				// System.out.println(UtilityBelt.executeShellCommand("mseG -m 1 -M 12 -b 1 -r 0.000001 -R 0.000001 -n 1
				// <Testy1>delete1_3.mse"));//
				...
				// System.out.println(UtilityBelt
				// .executeShellCommand4("mseG -m 1 -M 12 -b 1 -r 0.000001 -R 0.000001 -n 1
				// </home/gunjan/cprograms/Testy1>/home/gunjan/cprograms/delete1_4.mse"));
				// System.out.println(UtilityBelt.executeShellCommand4("mseG -m 1 -M 12 -b 1 -r 0.000001 -R 0.000001 -n
				// 1 <Testy1>delete1_4.mse"));
			...
			/*
			 * Timestamp ts= new Timestamp(2014-1900,3,13,14,9,6,0); long durationInSeconds = 12*24*60*60;
			 * TreeMap<Timestamp,Long> map=DatabaseCreatorDCU.breakActivityEventOverDays(ts, durationInSeconds);
			 * 
			 * for (Map.Entry<Timestamp, Long> entry : map.entrySet()) {
	...
	public static void checkSAX()
	{
		...
		try
		{
			...
			// 10));
			System.out.println(
					"String representation = " + org.activity.util.SAXUtils.getSAXString(vals, stamps, 12, 20));
	...
	public static int recursiveLevenshteinDistance(String s, int len_s, String t, int len_t)
	{
		...
		return minimum(recursiveLevenshteinDistance(s, len_s - 1, t, len_t) + 1,
				recursiveLevenshteinDistance(s, len_s, t, len_t - 1) + 1,
