...
//	public static final String[] setOfalphabetsOfActivityNames = { "A", "AB", "ABC", "ABCD", "ABCDE", "ABCDEFG", "ABCDEFGHI", "ABCDEFGHIJK", "ABCDEFGHIJKLMNO" };
...
//				}
//				
//				WritingToFile.writeArrayList(editDistances, "SynthTimelinesEditDistances" + alphabetOfActivityNames.length() + "MU" + mu, "EditDistance",
...
//			// WritingToFile.writeArrayListOfArrayList(allMUEditDistances, "SyntheticTimelinesEditDistances" + alphabetOfActivityNames.length(), "MatchingUnit,PairIndex,EditDistance",
//			// "/run/media/gunjan/OS/Users/gunjan/Documents/UCD/Projects/GeoLife/link to Geolife Data Works/SyntheticTimelines/");
//		}
//	}
//	
...
//		//
//		// Pair<String, Double> editDistance = es.getHJEditWithTrace(t1.getActivityObjectsInTimelineFromToIndex(0, mu - 1), t2.getActivityObjectsInTimelineFromToIndex(0, mu - 1));
//		// editDistances.add(editDistance);
//		
//		return UtilityBelt.round((es.getHJEditDistanceWithTrace(t1.getActivityObjectsInTimelineFromToIndex(0, mu - 1), t2.getActivityObjectsInTimelineFromToIndex(0, mu - 1))).getSecond(), 4);
//	}
//	
...
//	
//	/**
//	 * Note: the activity objects are different with respect to activity name and activity duration (iff randomTimeDuration is true), other features are same.
//	 * 
//	 * @param beginTS
//	 * @param count
//	 * @return
...
//		int timeDurationInSeconds = 60 * (r.nextInt(4 * 60) + 10); // between 10 minutes and 4hrs 10 minutes//2 * 60 * 60 + r.nextInt(10 * 60);// between 2 hrs and 2hrs plus 10 minutes 60 *
