...
public class CheckSerialisation
{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			// String deserialisedString = (String) Serializer.deSerializeThis(commonPath + "testString.strObj");//
			// (testString, commonPath + "testString.strObj");
			//
			Serializer.fstSerializeThis(testString, commonPath + "testString.strObj_fst");
			String fstDeserialisedString = (String) Serializer.fstDeSerializeThis(commonPath + "testString.strObj_fst");// ,
																														// new
																														// String());//
																														// (testString,
																														// commonPath
			...
			// String kryoDeserialisedString = (String) Serializer.kryoDeSerializeThis(commonPath +
			// "testString.strObj_kryo");// , new String());// (testString, commonPath +
			//
			...
			//
			// System.out.println("Both deserialised strings are equal ? " +
			// deserialisedString.equals(kryoDeserialisedString));
			// System.out.println("original string == kryoDeserialisedString ? " +
			// testString.equals(kryoDeserialisedString));
			//
			// System.out.println("Both deserialised strings are equal ? " +
			// deserialisedString.equals(fstDeserialisedString));
			// System.out.println("original string == fstDeserialisedString ? " +
			// testString.equals(fstDeserialisedString));
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	public static void checkSerialisationLL(LinkedHashMap<String, LinkedHashMap<String, Integer>> mapLL)
	{
		...
		LinkedHashMap<String, LinkedHashMap<String, Integer>> kryoDeserialisedMap = (LinkedHashMap<String, LinkedHashMap<String, Integer>>) Serializer
				.kryoDeSerializeThis(commonPath + "mapLL.ser");// , new String());// (testString, commonPath +
		// "testString.strObj");
	...
	public static void checkSerialisationLT(LinkedHashMap<String, TreeMap<String, Integer>> mapLT)
	{
		...
		LinkedHashMap<String, TreeMap<String, Integer>> kryoDeserialisedMap = (LinkedHashMap<String, TreeMap<String, Integer>>) Serializer
				.kryoDeSerializeThis(commonPath + "mapLT.ser");// , new String());// (testString, commonPath +
		// "testString.strObj");
