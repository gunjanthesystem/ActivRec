package org.activity.jmotif.algorithm;
...
public final class MatrixFactory
{
	 ...
	 * @param b
	 *            the second matrix.
	 * @return true if matrices are equal, false in the case where at least one element is not equal, or matrices are of
	...
	/**
	 * Mimics Matlab function for reshape: returns the m-by-n matrix B whose elements are taken column-wise from A. An
