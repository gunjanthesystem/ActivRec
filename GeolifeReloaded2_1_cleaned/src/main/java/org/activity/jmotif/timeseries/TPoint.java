...
public final class TPoint implements Comparable<TPoint>, Serializable
{
	...
	/**
	 * Compares the TPoint object with other TPoint using timestamps first: i.e. by the timestamp values, if they are
	 * equal, the TPoint values used.
	 *
	 * @param o
	 *            the TPoint to compare with.
	 *
