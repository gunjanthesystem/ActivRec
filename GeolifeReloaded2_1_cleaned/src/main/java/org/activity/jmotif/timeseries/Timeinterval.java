package org.activity.jmotif.timeseries;
...
public final class Timeinterval implements Comparable<Timeinterval>
{
	...
	public boolean equals(Object o)
	{
		if (o instanceof Timeinterval)
		{
			...
			if ((this.value == ti.getValue()) && (this.start == ti.getStart()) && (this.end == ti.getEnd()))
			{
				return true;
			}
		}
	...
	/**
	 * Compares the TimeInterval object with other TimeInterval using START timestamps first: i.e. by the timestamp
	 * values, if they are equal, the END values or VALUE used.
	 * 
	 * @param o
	 *            the TimeInterval to compare with.
	 * 
