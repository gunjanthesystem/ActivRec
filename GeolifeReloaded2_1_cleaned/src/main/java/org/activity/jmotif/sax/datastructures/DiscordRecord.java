...
/**
 * The discord data record. Kind of useful of keeping information concerning a discord occurrence etc...
 * 
 * @author Pavel Senin
 * 
 */
public class DiscordRecord implements Comparable<DiscordRecord>
{
	 ...
	 * 
	 * @param index
	 *            The index discord found at.
	 * @param dist
	 *            The distance from other sequences.
	 */
	 ...
	 * 
	 * @param other
	 *            The discord record this is compared to.
	...
	{
		return "'" + this.payload + "', distance " + this.getDistance() + " position: " + this.getPosition();
	}
