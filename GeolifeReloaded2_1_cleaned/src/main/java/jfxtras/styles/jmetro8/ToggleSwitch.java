...
public class ToggleSwitch extends Labeled
{
	...
	/**
	 * Toggles the state of the {@code ToggleSwitch}. If allowIndeterminate is true, then each invocation of this
	 * function will advance the CheckBox through the states checked, unchecked, and undefined. If allowIndeterminate is
	 * false, then the CheckBox will only cycle through the checked and unchecked states, and forcing indeterminate to
	 * equal to false.
	 */
	public void fire()
	{
