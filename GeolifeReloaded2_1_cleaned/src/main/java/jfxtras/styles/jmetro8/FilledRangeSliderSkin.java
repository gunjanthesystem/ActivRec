...
// */
// public class FilledRangeSliderSkin extends BehaviorSkinBase<RangeSlider, SliderBehavior>
// {
//
// /** Track if RangeSlider is vertical/horizontal and cause re layout */
...
//
// public FilledRangeSliderSkin(Slider slider)
// {
...
// ? trackStart
// + (((trackLength * ((s.getValue() - s.getMin()) / (s.getMax() - s.getMin()))) - thumbWidth / 2))
// : thumbLeft;
// final double endY = (horizontal) ? thumbTop
// : snappedTopInset() + trackLength
// - (trackLength * ((s.getValue() - s.getMin()) / (s.getMax() - s.getMin()))); // - thumbHeight/2
//
// if (animate)
// {
...
// fill.resizeRelocate((int) (trackStart - trackRadius), trackTop,
// ((int) trackStart - trackRadius) + thumb.getLayoutX(), trackHeight);
// // layout tick line
// if (showTickMarks)
// {
...
// fill.resizeRelocate(trackLeft, ((int) trackStart - trackRadius) + thumb.getLayoutY(), trackWidth,
