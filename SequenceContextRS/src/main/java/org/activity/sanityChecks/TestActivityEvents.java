...
// {
// ActivityObject AE11 = new ActivityObject("A", "loc", 60 * 60, new Timestamp(2014 - 1900, 4 - 1, 12, 7, 0, 0, 0));//
// ActivityObject(String activityName, String location, long durationInSeconds,
...
// TL1.add(AE13);
//
// ActivityObject AE21 = new ActivityObject("A", "loc", 130 * 60, new Timestamp(2014 - 1900, 4 - 1, 12, 7, 0, 0, 0));//
// ActivityObject(String activityName, String location, long
