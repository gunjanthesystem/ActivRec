...
/**
 * The implementation of the magic array structure. It should contain all of the words obtained by sliding window over
 * the timeseries.
 * 
 * @author Pavel Senin.
 * 
 */
public class SAXTrieHitEntry implements Comparable<SAXTrieHitEntry>
{
	 ...
	 * 
	 * @param complexity
	 *            If 1 - single letter used, 2 - two or more letters, 3 - 3 or more etc..
	 * 
	...
	{
		return "payload: " + String.valueOf(this.payload) + ", frequency: " + this.frequency + ", location: "
				+ this.position;
	}
}