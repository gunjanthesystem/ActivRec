...
/**
 * NOT USED Fork of org.activity.loader.GeolifeDataLoader for using mapForAllDataMergedPlusDuration to recreated DCU
 * lifelog timelines. Will use comments to redo things
 * 
 * @author gunjan
 * @since 10 Dec 2018
 * @deprecated
 */
public class DataLoaderDec2018ForDCU
{
	...
	/*********** PARAMTERS TO SET ***************/
	// static String commonPath = "/run/media/gunjan/HOME/gunjan/Geolife Data
	// Works/21April2016AllUsersDataGenerationUMAPAgainCorrectedTimeZone/";//
	// "/run/media/gunjan/Space/GUNJAN/GeolifeSpaceSpace/May18AllUsersDataGeneration2/";
	static String dataLoadingLogFilename = "dataLoadingLog10Dec2018.txt";
	// "dataLoadingLog21April2016.txt";// "dataLoadingLog18May.txt";
	static String nameForDataMapSerialised;
	// = "mapForAllDataMergedPlusDuration21Apr2016UMAPCorrectedTimeZone.map";//
	...
	public static void main(String[] args)
	{
		try
		{
			...
			/// ConnectDatabase.truncateAllData("dcu_data_2");
			...
			Constant.initialise(commonPath, "dcu_data_2");
			// Constant.setDatabaseName("geolife1");
			// ConnectDatabase.initialise(Constant.getDatabaseName()); // all method and variable in this class are
			// static
			...
			mapForAllDataMergedPlusDuration = (LinkedHashMap<String, TreeMap<Timestamp, String>>) Serializer
					.deSerializeThis(
							"/home/gunjan/git/GeolifeReloaded2_1_cleaned/dataToRead/DCULLFromBackup/mapForAllDataMergedPlusDuration.map");

			System.out.println("mapForAllDataMergedPlusDuration.size()= " + mapForAllDataMergedPlusDuration.size());

			// /// Start of curtain Dec 10 2018
			// // deserialiser for distributed data
			// // mapForAllDataMergedPlusDuration = (LinkedHashMap<String, TreeMap<Timestamp, TrajectoryEntry>>)
			// // (Serializer
			...
			writeMapForAllData(mapForAllDataMergedPlusDuration, commonPath);
			System.exit(0);
			//
			...
			// StatsUtils.averageDecimalsAsStrings(UtilityBelt.removeInvalidAlts(te.getAltitude())));//
			// .stream().a//.mapToDouble(a
			// // ->
			//
			...
			// // sensitive.
			//
			// toInsertInActivityFact.add(activityLogEntry); //
			// ConnectDatabase.insertIntoActivityFact(activityLogEntry);
			//
			// if (!(uniqueTimeIds.contains(timeId)))
			// {
			// toInsertInTimeDimension.add(activityLogEntry);//
			...
			// {
			// toInsertInDateDimension.add(activityLogEntry);//
			...
			// {
			// toInsertInLocationDimension.add(activityLogEntry);//
			// ConnectDatabase.insertIntoLocationDimensionTrajectory(activityLogEntry);
